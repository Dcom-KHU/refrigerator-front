    ...
    return (
        <div className="pt-20  px-5 py-10 mx-auto ">
            <div className="flex flex-col my-auto items-center mx-3">
                <p className="font-mono py-px font-semibold text-2xl items-center">
                    오늘의 추천 레시피
                </p>
            </div>
                        ...
                        <div className="md:shrink-0">
                            ...
                            >
                                <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                                    <img
                                        className="h-48 w-full object-cover md:h-full md:full"
                                        src="https://i.pinimg.com/474x/6e/26/4c/6e264cbcbce8ae7a39ed463f4070c77b.jpg"
                                    />
                                </div>

                                <div className="p-8">
                                    <div className="uppercase tracking-wide text-sm text-grey-500 font-semibold">
                                        떡볶이
                                    </div>
